...
**英語**\|[中文](./README_ZH.md)\|[ドイツ語](./README_DE.md)\|[フランス語](./README_FR.md)\|[スペイン語](README_ES.md)\|[日本語](./README_JA.md)
...
-   **複数検索の入力形式**: テキスト、画像、ファイル、Web ページ、特に複数画像の検索、比較、要約、分析をサポートします。
-   **複数の結果の提示方法**: テキスト、マインド マップ、画像、ビデオ。
...
-   **Web 検索の自動決定**：インターネット検索を実行するタイミングを自動的に決定します。
