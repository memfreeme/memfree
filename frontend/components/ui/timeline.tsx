...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            'absolute top-[5px] left-[55px] -translate-x-1/2 translate-y-2 h-full w-px bg-primary',
            className,
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            'flex flex-col size-2 bg-primary rounded-full ml-4 mf-2',
            className,
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn('flex flex-col items-start pl-10', className)}
        {...props}
    />
));
