...
const benefits = ['Premium1', 'Premium2', 'Premium9', 'Premium3', 'Premium4', 'Premium5', 'Pro10', 'Premium6', 'Pro7', 'Pro8', 'Pro9'] as const;
...
export const UpgradeModal = () => {
    ...
    return (
        <Modal showModal={upgradeModal.isOpen} setShowModal={upgradeModal.onClose}>
            <div className="grid w-full py-10 px-4 sm:py-6 sm:px-2">
                <div>
                    <h3 className="font-semibold text-center sm:text-base mb-4">{t('upgrade-call')}</h3>
                </div>
