...
const validModels = [GPT_4o_MIMI, GPT_4o, O1_MIMI, O1_PREVIEW, Claude_35_Sonnet, Claude_35_Haiku, DEEPSEEK, GEMIMI_2];

const proModels = [GPT_4o, Claude_35_Sonnet, Claude_35_Haiku, O1_MIMI, O1_PREVIEW, GEMIMI_2];

export const ImageInputModels = [GPT_4o, GPT_4o_MIMI, Claude_35_Sonnet, GEMIMI_2];
